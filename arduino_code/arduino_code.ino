...
//        String stringX = String("X" + x);
//        Serial.println(stringX);       
        String y = String(pixy.blocks[j].y);
//        String stringY = String("Y" + y);
//        Serial.println(stringY);
        String w = String(pixy.blocks[j].width);
        String h = String(pixy.blocks[j].height);
        String totalString = String(x+";"+y+";"+w+";"+h);
